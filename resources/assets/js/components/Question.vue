                            ...
                            <div class="row">
                                <div class="col-4">
	                                ...
	                                <a v-if="authorize('modify',question)" @click.prevent="edit" class="btn btn-sm btn-outline-info">Edit</a>
                                        ...
                                        <button v-if="authorize('deleteQuestion',question)" @click="destroy" class="btn btn-sm btn-outline-danger" type="button">Delete</button>
	                                
                                    </div>
                                </div>                               
                                <div class="col-4"></div>
                                <div class="col-4"><user-info :model="question" label="Asked"></user-info></div>
                            </div>
                        </div>
                    </div>
                </div>
...
export default{
    ...
    data(){
        return{
            ...
            answerCount:this.question.answers_count,
            id:this.question.id,
            beforeEditCache:{}
        }
    },
    computed:{
        isInvalid(){
           return this.title.length < 5 || this.body.length <10;
        },
        endpoint(){
